...
const Avatar = ({ src, name }: AvatarProps) => {
  return (
    <div
      style={{ width: AVATAAR_SIZE, height: AVATAAR_SIZE }}
      className="group -ml-2 flex shrink-0 place-content-center relative border-0 border-white rounded-full bg-gray-400 "
    >
