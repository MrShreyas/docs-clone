...
const Marker = ({
  ...
  return (
    <div
      className="absolute top-0 w-4 h-4 cursor-ew-resize z-[5] group -ml-2 "
      style={{ [isLeft ? "left" : "right"]: `${position}px` }}
      onMouseDown={onMouseDown}
      onDoubleClick={onDoubleClick}
    >
      <FaCaretDown className=" absolute left-1/2 top-0 h-full fill-blue-950 transform -translate-x-1/2 " />
      <div
